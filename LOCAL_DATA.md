...
into this checkout on 2026-08-18. This checkout contains 277 files in Git-ignored data paths:

- `artifacts/`: 7 files
- `releases/`: 158 files
- `source_snapshots/`: 112 files

Together they total 7,749,952,616 bytes. `LOCAL_DATA_SHA256SUMS` records every local payload file.
