...
`[2026-09-07T00:00:00Z, 2026-09-07T10:00:00Z)`. The final local `r2` freeze was sealed at
`2026-09-07T11:01:50.920409Z` and binds 335 retained files.
...
- `artifacts/2026-09-07-curated-observation-population-v1-r2-frozen.json`, 520,156 bytes,
  SHA-256 `156359ae95653157991712d4d3abe04ecf0f7099b0d54e46b19431dcd0fdb825`.
- `artifacts/2026-09-07-curated-observation-population-v1-r2-verification.json`, generated by
  `artifacts/2026-09-07-verify-curated-observation-population.py`, SHA-256
  `c27097d0b632d3d9dd3f58d558ed7cc1be987d0029f19fa908abe411816c6e30`.

The earlier uncommitted `v1-frozen` file is a retained validation candidate made before the
historical replay improvement. It is not the final candidate and its pinned implementation
differs; do not replace its code fingerprints or treat it as current.
...
and Amkor diagnostic scores. Eighteen focused tests cover unimported and interrupted captures,
...
The final local suite passed 988 core and 12 web tests; all 353 checksum-listed payloads passed.
